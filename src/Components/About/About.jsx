            ...
            <div className="container marketing">
                <div className="row featurette">
                    <div className="col-md-7">
                        ...
                        <p className="lead">Cuillère Africaine est née de la passion pour la cuisine africaine authentique. 
                ...
                <div className="row featurette">
                    <div className="col-md-7 order-md-2">
                        <h2 className="featurette-heading fw-normal lh-1">Notre Histoire </h2>
                        <p className="lead">
                ...
                <div className="row featurette">
                    <div className="col-md-7">
                        <h2 className="featurette-heading fw-normal lh-1">L'Essence de Cuillère Africaine.</h2>
                        <p className="lead">
